...
public class Practice {
    ...
    public void practice1(){
        ...
        String expectedText = "I am an alert boxss!";
        ...
        softAssert.assertEquals(actualClick1,expectedClick1);
        ...
        String expectedClick3 = "You entered text Janysh in propmt popup";  //there is a bug here
        softAssert.assertEquals(actualClick3,expectedClick3);
